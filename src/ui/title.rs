...
//!
//! Produces a stable `tuxtime <path>` title so the window/tab title is
...
mod tests {
    ...
    fn shows_full_home_relative_path_when_it_fits() {
        ...
        assert_eq!(title, "tuxtime ~/work/todo.txt");
    }
    ...
    fn collapses_only_as_many_leading_dirs_as_needed() {
        ...
        let title = terminal_title(
            Path::new("/Users/m/projects/github/webstonehq/tuxtime/todo.txt"),
            Some(Path::new("/Users/m")),
            35,
        );
        assert_eq!(title, "tuxtime ~/p/g/w/tuxtime/todo.txt");
    }
    ...
    fn preserves_leading_dot_when_shortening_dotfiles() {
        ...
        assert_eq!(title, "tuxtime ~/.c/nvim/notes.txt");
    }
    ...
    fn shows_relative_path_without_prefix() {
        ...
        assert_eq!(title, "tuxtime notes/todo.txt");
    }
}
